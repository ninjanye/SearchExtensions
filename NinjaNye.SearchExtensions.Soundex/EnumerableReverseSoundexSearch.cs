...
{
    public class EnumerableReverseSoundexSearch<T> : EnumerableSearchBase<T, string>
    {
        public EnumerableReverseSoundexSearch(IEnumerable<T> source, Expression<Func<T, string>>[] stringProperties) 
