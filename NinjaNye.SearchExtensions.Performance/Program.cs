...
namespace NinjaNye.SearchExtensions.Performance
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //PerformSoundexTest(words);

            LevenshteinTestForOneMillionRecords();

            Console.ReadLine();
        }

        private static void LevenshteinTestForOneMillionRecords()
        {
            Console.WriteLine("====================================");
        ...
        private static void PerformSoundexTest(string[] words)
        {
