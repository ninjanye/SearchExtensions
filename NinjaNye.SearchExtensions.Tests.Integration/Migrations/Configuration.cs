    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TestContext>
    {
        ...
        protected override void Seed(TestContext context)
        {
            context.TestModels.AddOrUpdate(tm => tm.Id,
              ...
              new TestModel { Id = new Guid("A8AD8A4F-853B-417A-9C0C-0A2802560B8C"), StringOne = "wholewordmatch", StringTwo = "words are not spaced", StringThree = "whole"},
              new TestModel { Id = new Guid("CADA7A13-931A-4CF0-B4F4-49160A743251"), StringOne = "whole word match", StringTwo = "words are spaced", StringThree = "whole"},
